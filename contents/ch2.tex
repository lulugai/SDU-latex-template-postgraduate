...
\begin{figure}[htbp]
\centering
\subfloat[GIST]{\includegraphics[width=0.3\textwidth]{GIST.jpg}}
~~
\subfloat[DeCAF$_1$]{\includegraphics[width=0.3\textwidth]{DECAF1.jpg}}
~~
\subfloat[DeCAF$_6$]{\includegraphics[width=0.3\textwidth]{DECAF6.jpg}}
\caption{这是标题}
\label{thisiisalabel}
\end{figure}
...
\hline
图像&
\tabincell{c}{\includegraphics[width=0.35\textwidth]{9ddQpU7yeNmEzUXu.jpg}\\9ddQpU7yeNmEzUXu.jpg} &
\tabincell{c}{\includegraphics[width=0.42\textwidth]{9_cX52_TUIjODdac.jpg}\\9\_cX52\_TUIjODdac.jpg} \\
